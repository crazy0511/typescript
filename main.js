...
(function (Color) {
    Color["Red"] = "m\u00E0u \u0111\u1ECF";
    Color["Green"] = "m\u00E0u xanh l\u1EE5c";
    Color["Blue"] = "m\u00E0u xanh d\u01B0\u01A1ng";
})(Color || (Color = {}));
;
var Film;
(function (Film) {
    Film[Film["PhimMoi"] = 0] = "PhimMoi";
    Film[Film["PhimMoii"] = 1] = "PhimMoii";
    Film[Film["PhimChill"] = 2] = "PhimChill";
})(Film || (Film = {}));
let red = Color.Red;
// console.log(red);
